		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "TestProject",
									"targetURL": "#comtipsvallytestproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comtipsvallytestproject-display": {
								"semanticObject": "comtipsvallytestproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.tipsvally.testproject",
									"url": sap.ui.require.toUrl("com/tipsvally/testproject")
								}
							}
						}
					}
